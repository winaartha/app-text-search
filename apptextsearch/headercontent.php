...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-dark fixed-top">
  <a class="navbar-brand text-white" href="#">Halaman | <b>UPLOAD</b> </a>
  <div class="icon ml-4">
    <h5>
...
<div class="row no-gutter mt-5 p-2">
  <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
    <ul class="nav flex-column ml-3 mb-5">
     ...
     <li class="nav-item">
        <a class="nav-link text-white" href="dashboard.php?page=upload"><i class="fas fa-newspaper mr-2"></i>Upload</a><hr class="bg-secondary">
     </li>
     <li class="nav-item">
        <a class="nav-link text-white" href="dashboard.php?page=list"><i class="fas fa-users-cog mr-2"></i>List Dokumen</a><hr class="bg-secondary">
     </li>
  </ul>
</div>
